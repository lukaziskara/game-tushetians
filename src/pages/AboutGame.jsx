...
export default function Home() {
  return (
    <div className="about">
      ...
      <p>
        უნდა აირჩიოთ თემატიკა, რომლის მიხედვითაც შედგენილ წინადადებებზე მოგიწევთ
        თამაში და დააჭიროთ შესაბამის ღილაკს წარწერით “ჩამოშლა”.
      </p>
      <h2>S: მახასიათებლები.</h2>
      <img src="photos_about/2.jpg" alt="" />
      <p>
        უნდა აირჩიოთ თამაშის სირთულე ღილაკებზე დაჭერით. Ნაწილს აწერია “მარტივი”,
        ნაწილს - “რთული”. Ქვემოთ გამოსახულია ბარათების ნიმუშები იმ ფორმით,
        რომლითაც პირველ თამაშში შეგხვდებათ. თამაშის დასაწყებად უნდა დააჭიროთ
        ღილაკს "დაწყება". Მომდევნო ეტაპებზე განსხვავებული სირთულეები ჯერ არაა.
      </p>
      <h2>I: ლექსიკონი.</h2>
      ...
      <p>
        ...
        სიტყვებით უნდა შეივსოს. Ქვემოთ მოცემული შემთხვევითად დალაგებულ სიტყვებს
        დააჭირეთ ისეთი თანმიმდევრობით რომ თარგმანის შესაბამისი წინადადება სწორად
        აიწყოს. Წინადადების აწყობის შემდეგ გამოჩნდება ღილაკი “შემდეგი”, რომელზე
        დაჭერითაც შემდეგ წინადედაბაზე გადახვალთ. Ოთხი წინადადების შედგენის
        შემთხვევაში, შემდეგ ეტაპზე გადასვლას შედეგების განულების გარეშე შეძლებთ.
      </p>
      ...
      <p>
        Აქ ბოლო ეტაპის(ახლა სასვენი ნიშნებია ასეთი) გავლის შემდეგ მიღებული
        შედეგები და წინადედაბები, მათი თარგმანებით გამოჩნდება.
      </p>
=======
